...
<div id="container" style="overflow: hidden;">
	...
	<div class="row" style="padding-top: 2%;">
		...
		<div class="col-sm-4 col-md-4 col-lg-4" style="padding-left: 0px;margin-left: 0px;">
				<video height="270.21px" width="406px" controls controlsList="nodownload"  disablePictureInPicture>
				  <source src="<?php echo $video_status[0]['standardVideoUrl']; ?>" type="video/mp4">
